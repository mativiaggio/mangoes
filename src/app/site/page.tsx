        ...
        <section
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <p className="max-w-6xl text-sm mb-8 text-muted-foreground">
              Nuestros planes están diseñados para ofrecerte las herramientas y
              el soporte que necesitas para hacer crecer tu negocio. Ya sea que
              estés comenzando o busques expandir tu empresa, tenemos la opción
              perfecta para ti. Elige el plan que mejor se adapte a tus
